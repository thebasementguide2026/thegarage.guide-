    ...
    <>
      ...
      <article className='container-custom py-8 max-w-4xl mx-auto'>
        ...
        <section className='mb-8'>
          ...
          <p className='text-slate-700 text-sm leading-relaxed'><strong>Critical safety warning:</strong> Never pull the emergency release cord while the door is open if you suspect a broken spring. Without spring tension, the door&apos;s full weight (150 to 400 lbs) is unsupported and can slam down uncontrollably. According to the <a href='https://www.cpsc.gov/FAQ/Automatic-Residential-Garage-Door-Operators' target='_blank' rel='noopener noreferrer' className='text-amber-700 underline'>U.S. Consumer Product Safety Commission</a>, garage doors are one of the heaviest moving objects in a home.</p>
        </section>
