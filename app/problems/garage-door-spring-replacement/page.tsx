        ...
        <section className='mb-8'>
          ...
          <div className='space-y-4'>
            ...
            <div className='border border-slate-200 rounded-lg p-4'>
              ...
              <p className='text-slate-700 text-sm'>No. Torsion spring replacement is one of the most dangerous DIY repairs a homeowner can attempt. The springs store over 200 lbs of mechanical force. If a winding bar slips during installation, it spins with the full rotational force of the spring, causing broken bones, facial fractures, and in documented cases, fatalities. The <a href='https://www.cpsc.gov/FAQ/Automatic-Residential-Garage-Door-Operators' target='_blank' rel='noopener noreferrer' className='text-amber-700 underline'>Consumer Product Safety Commission</a> tracks over 20,000 garage door related emergency room visits annually. Professional replacement costs $150 to $350 and takes under an hour. The cost savings of DIY do not justify the injury risk.</p>
            </div>
            <div className='border border-slate-200 rounded-lg p-4'>
