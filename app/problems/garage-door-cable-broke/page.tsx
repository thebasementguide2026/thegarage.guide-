    ...
    <>
      <article className='container-custom py-8 max-w-4xl mx-auto'>
        ...
        <section className='mb-8'>
          ...
          <p className='text-slate-700 text-sm leading-relaxed mb-3'><strong>Broken torsion spring:</strong> A broken torsion spring changes the load the cable carries. When a spring breaks, the door becomes much heavier to lift and the remaining cable carries a load it was not designed to handle alone. A broken torsion spring dramatically increases the load on the remaining cable and is one of the most common triggers for cable failure. A cable that fails within days or weeks of a spring replacement was probably already at end of life. See our <Link href='/problems/garage-door-spring-replacement' className='text-amber-700 underline'>garage door spring replacement guide</Link> for what that repair involves professionally.</p>
          ...
          <p className='text-slate-700 text-sm leading-relaxed mb-3'><strong>Impact or obstruction:</strong> A vehicle that bumped the bottom of the door, a roller that seized in the track, or an object in the path of the door can all create a sudden shock load that snaps a cable that is otherwise near the end of its life. A broken cable frequently causes the door to come off its tracks at the same time. If the door is also derailed, see our <Link href='/problems/garage-door-off-track' className='text-amber-700 underline'>garage door off track guide</Link> for diagnosis and next steps.</p>
