  ...
  return (
    <>
      ...
      <div className='max-w-3xl mx-auto px-4 mb-16'>
        ...
        <p className='text-slate-700 leading-relaxed mb-4 text-sm'>Always coat before installing any wall-mounted storage, ceiling racks, or cabinets. Coating a bare, empty floor is straightforward. Coating around installed systems requires masking, cutting in with brushes, and produces a less consistent result. Our <Link href='/guides/garage-organization' className='text-amber-700 underline'>complete garage organization guide</Link> covers the recommended installation sequence in detail.</p>
      ...
      <div className='max-w-3xl mx-auto px-4 mb-16'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
          <Link href='/guides/garage-organization' className='block p-4 border border-slate-200 rounded hover:border-amber-700 transition'>
          ...
          <Link href='/guides/how-to-insulate-your-garage' className='block p-4 border border-slate-200 rounded hover:border-amber-700 transition'>
            <span className='inline-block bg-amber-700 text-white text-xs font-bold uppercase tracking-wider px-2 py-0.5 mb-2'>Guide</span>
