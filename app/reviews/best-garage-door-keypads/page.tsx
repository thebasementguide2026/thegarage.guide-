      ...
      <div className='max-w-3xl mx-auto px-4 mb-16'>
        ...
        <div className='max-w-3xl mx-auto px-4 mb-16'>
          ...
          <div className='border border-slate-200 rounded-lg p-6 mb-8'>
            ...
            <a href='https://amzn.to/placeholder-gukr' target='_blank' rel='noopener noreferrer' className='inline-block bg-amber-700 text-white text-sm font-bold px-6 py-3 rounded hover:bg-amber-800 transition-colors'>Check Price on Amazon</a>
          </div>
          ...
          <div className='border border-slate-200 rounded-lg p-6 mb-8'>
            ...
            <a href='https://amzn.to/placeholder-878max' target='_blank' rel='noopener noreferrer' className='inline-block bg-amber-700 text-white text-sm font-bold px-6 py-3 rounded hover:bg-amber-800 transition-colors'>Check Price on Amazon</a>
          </div>
          ...
          <div className='border border-slate-200 rounded-lg p-6 mb-8'>
            ...
            <a href='https://amzn.to/placeholder-klik5u' target='_blank' rel='noopener noreferrer' className='inline-block bg-amber-700 text-white text-sm font-bold px-6 py-3 rounded hover:bg-amber-800 transition-colors'>Check Price on Amazon</a>
          </div>
          ...
          <div className='border border-slate-200 rounded-lg p-6 mb-8'>
            ...
            <a href='https://amzn.to/placeholder-myq' target='_blank' rel='noopener noreferrer' className='inline-block bg-amber-700 text-white text-sm font-bold px-6 py-3 rounded hover:bg-amber-800 transition-colors'>Check Price on Amazon</a>
          </div>
          ...
          <div className='border border-slate-200 rounded-lg p-6 mb-8'>
            ...
            <a href='https://amzn.to/placeholder-gkr' target='_blank' rel='noopener noreferrer' className='inline-block bg-amber-700 text-white text-sm font-bold px-6 py-3 rounded hover:bg-amber-800 transition-colors'>Check Price on Amazon</a>
          </div>
          ...
          <div className='border border-slate-200 rounded-lg p-6 mb-8'>
            ...
            <a href='https://amzn.to/placeholder-xxhouse' target='_blank' rel='noopener noreferrer' className='inline-block bg-amber-700 text-white text-sm font-bold px-6 py-3 rounded hover:bg-amber-800 transition-colors'>Check Price on Amazon</a>
          </div>
        </div>
