  ...
  return (
    <>
      ...
      <div className='max-w-3xl mx-auto px-4 mb-16'>
        ...
        <p className='text-slate-700 leading-relaxed mb-4 text-sm'>For how keypads fit into a broader garage security and smart home system, see our <Link href='/problems/garage-door-opener-not-working' className='text-amber-700 underline'>garage door opener troubleshooting guide</Link> for common opener issues. If your opener works fine but lacks WiFi, a <Link href='/guides/smart-garage-door-opener-retrofit' className='text-amber-700 underline'>smart garage door opener retrofit</Link> adds app control and voice commands for $36 to $220 without replacing the unit.</p>
      </div>
