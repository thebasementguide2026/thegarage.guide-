...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Are garage door keypads universal?', acceptedAnswer: { '@type': 'Answer', text: 'Some are and some are not. The Genie GUK-R Universal, Overhead Door OUK-BX, and X X-House Universal keypads work with most garage door opener brands manufactured since 1993. The LiftMaster 878MAX works only with LiftMaster, Chamberlain, and Craftsman. The Genie GK-R works only with Genie and Overhead Door.' } },
    ...
    { '@type': 'Question', name: 'Can a garage door keypad control multiple doors?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. The Genie GUK-R Universal and Genie GK-R both program up to 3 separate openers from one keypad. The Overhead Door OUK-BX programs up to 3 openers. The X X-House Universal programs 2 openers.' } },
...
const keypadComparisonSchema = {
  ...
  variableMeasured: [
    ...
    { '@type': 'PropertyValue', name: 'Overhead Door OUK-BX', value: 'Universal most brands since 1993, temp PIN yes, backlit yes, Auto-Seek frequency rolling code, $35-$45' },
  ...
  return (
    <>
      ...
      <div className='max-w-3xl mx-auto px-4 mb-16'>
        ...
        <p className='text-slate-700 leading-relaxed mb-4 text-sm'>For how keypads fit into a broader garage security and smart home system, see our <Link href='/problems/garage-door-opener-not-working' className='text-amber-700 underline'>garage door opener troubleshooting guide</Link> for common opener issues. For homeowners who want to extend smart control to the garage door opener itself (not just the keypad), see our guide on <Link href='/guides/smart-garage-door-opener-retrofit' className='text-amber-700 underline'>smart garage door opener retrofit options</Link> for comparisons of myQ, HomeKit, and local-control hubs.</p>
      </div>
        ...
        <div className='overflow-x-auto my-6'>
          <table className='w-full text-xs border-collapse'>
            ...
            <tbody>
              ...
              <tr className='border-b border-slate-200'><td className='p-2'>Overhead Door OUK-BX</td><td className='p-2'>Universal (most brands since 1993)</td><td className='p-2'>Yes</td><td className='p-2'>Yes</td><td className='p-2'>No</td><td className='p-2'>Auto-Seek frequency rolling code</td><td className='p-2'>$35 &ndash; $45</td></tr>
      ...
      <div className='max-w-3xl mx-auto px-4 mb-16'>
        ...
        <div className='overflow-x-auto my-6'>
          <table className='w-full text-xs border-collapse'>
            ...
            <tbody>
              <tr className='border-b border-slate-200'><td className='p-2'>Purple or yellow</td><td className='p-2'>LiftMaster, Chamberlain, Craftsman (2011+)</td><td className='p-2'>LiftMaster 878MAX, Overhead Door OUK-BX, myQ Video Keypad, Genie GUK-R Universal</td></tr>
              <tr className='border-b border-slate-200 bg-slate-50'><td className='p-2'>Orange</td><td className='p-2'>LiftMaster, Chamberlain, Craftsman (2005&ndash;2011)</td><td className='p-2'>LiftMaster 878MAX, Overhead Door OUK-BX, Genie GUK-R Universal</td></tr>
              <tr className='border-b border-slate-200'><td className='p-2'>Red or green</td><td className='p-2'>LiftMaster, Chamberlain, Craftsman (1997&ndash;2005)</td><td className='p-2'>LiftMaster 878MAX, Overhead Door OUK-BX, Genie GUK-R Universal</td></tr>
              ...
              <tr className='border-b border-slate-200'><td className='p-2'>DIP switches (no learn button)</td><td className='p-2'>Pre-1997 openers, Linear, some others</td><td className='p-2'>Overhead Door OUK-BX, Genie GUK-R Universal, X X-House Universal</td></tr>
            </tbody>
          </table>
        </div>
        <p className='text-slate-700 leading-relaxed mb-4 text-sm'><strong>If you have a LiftMaster, Chamberlain, or Craftsman opener:</strong> The LiftMaster 878MAX is your safest choice because it is made by the same parent company (Chamberlain Group) that manufactures all three brands.</p>
        ...
        <p className='text-slate-700 leading-relaxed mb-4 text-sm'><strong>If you are unsure of your brand or have an older opener:</strong> The Overhead Door OUK-BX or Genie GUK-R Universal are the most broadly compatible options, supporting most openers manufactured since 1993.</p>
        <p className='text-slate-700 leading-relaxed mb-4 text-sm'><strong>If your opener has DIP switches instead of a learn button:</strong> Your opener predates rolling code security (pre-1997). The Overhead Door OUK-BX and X X-House Universal both support DIP switch programming, but consider upgrading your opener for security reasons because DIP switch openers use fixed codes that can be easily duplicated.</p>
      </div>
        ...
        <div className='max-w-3xl mx-auto px-4 mb-16'>
          ...
          <p className='text-slate-700 leading-relaxed mb-4 text-sm'>Some are and some are not. The Genie GUK-R Universal, Overhead Door OUK-BX, and X X-House Universal keypads work with most garage door opener brands manufactured since 1993. The LiftMaster 878MAX works only with LiftMaster, Chamberlain, and Craftsman. The Genie GK-R works only with Genie and Overhead Door.</p>
          ...
          <p className='text-slate-700 leading-relaxed mb-4 text-sm'>Yes. The Genie GUK-R Universal and Genie GK-R both program up to 3 separate openers from one keypad. The Overhead Door OUK-BX programs up to 3 openers. The X X-House Universal programs 2 openers.</p>
