...
const PROJECT_TYPE_OPTIONS = [
  ...
  { value: '88', label: 'Garage Doors Opener/Remote - Install' },
  { value: '89', label: 'Garage Doors Opener/Remote - Repair' },
  { value: '94', label: 'Garage Doors Spring Replacement' },
  { value: '91', label: 'Garage Doors Panel Replacement/Repair' },
  ...
  { value: '587', label: 'Garage or Asphalt Shed Roof Replacement' },
